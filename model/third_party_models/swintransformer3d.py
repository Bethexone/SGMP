...
from model.third_party_models.swin_transformer import PatchMerging, SwinTransformerBlock
...
class ShiftedWindowAttention3d(nn.Module):
    ...
    def get_relative_position_bias(self, window_size: List[int]) -> torch.Tensor:
        return _get_relative_position_bias(self.relative_position_bias_table, self.relative_position_index,
