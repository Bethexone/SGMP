...
class SetCriterion(nn.Module):
    ...
    def __init__(self, aux_loss=0, aux_loss_norm=0):
        super().__init__()
        self.num_classes = 1
...
if __name__ == '__main__':
    # mask = torch.randn(10, 1, 320, 256)
    # mask_2 = torch.randn(10, 1, 320, 256)
    # mask_4 = torch.randn(10, 1, 320, 256)
    # outputs = {}
    # outputs["pred_masks"] = mask
    # outputs["aux_pred_masks"] = []
    # outputs["aux_pred_masks"].append(mask_2)
    # outputs["aux_pred_masks"].append(mask_4)
    #
    # targets={}
    # targets["masks"] = mask
    #
    ...
    # print(losses)
    src_masks = torch.randn(10, 1, 320, 256)
